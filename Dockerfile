...
# digest together.
FROM --platform=$BUILDPLATFORM docker.io/node:26-trixie-slim@sha256:c0753125a3789977aefe869cbebccf70e3cfd7ea84ca48547458f02e4f1d7146 AS builder
...
FROM docker.io/node:26-trixie-slim@sha256:c0753125a3789977aefe869cbebccf70e3cfd7ea84ca48547458f02e4f1d7146 AS production
...
RUN npm ci --omit=dev --ignore-scripts \
    ...
    && node scripts/patch-wwebjs-expose-race.js \
