...
[ "$(env_value MCP_ENABLED)" = true ] || die 'MCP_ENABLED must be true for this deployment'
[ "$(env_value MCP_READONLY)" = false ] || die 'MCP_READONLY must be false for this deployment'
